...
description.innerText = "Pagination is the method of separating digital content into different pages on a website. Users can navigate between these pages by clicking below Buttons.";
document.body.appendChild(description)

var optdiv = document.createElement('div');
optdiv.setAttribute('class', 'table-responsive')
...
// - DOM- Day -2 : Document vs Window 14/05/2023 - Part 1 - Pagination -

var d = document.createElement('div');
d.setAttribute('class', 'd-flex justify-content-center');
d.id = "buttons"
